...
export default function Electrical() {
  const items = courses.filter((course) => course.track === 'electrical');
  return (
    <>
      <PageHeader eyebrow="Electrical" title="Electrical training track">Foundations, commercial systems, safety awareness, lockout readiness, panel documentation, and diagnostics.</PageHeader>
